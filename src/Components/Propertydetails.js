  ...
  return (
    <div style = {{backgroundColor: "#F1F2F2", minHeight: "100vh", paddingTop: isMobile? "3vw": "2vw"}}>
      ...
      <div style={{ width: "90%", height: isMobile? "40%": "20%", margin: "auto", marginTop: isMobile? "4vw": "2vw"}}>
        <Image style={{ width: "100%"}} src={`/${images[0]}`} alt="Property" onClick={() => setIsOpen(true)}/>
        {isOpen && (
      ...
      <Container style={{ width: isMobile ? "90%" : "50%", marginTop: isMobile? "5vw": "2vw", paddingTop: isMobile? "0.5vw": "0.1vw", 
       ...
       <div style = {{ display: "flex", maxWidth: "100%", width: "80%", justifyContent: "space-between", marginTop: isMobile ? "5vw" : "3vw", 
         ...
         <a style = {{padding: "1vw 4vw", backgroundColor: "red", color: "#fff", textDecoration: "none",
          fontFamily: "sans-serif", fontSize: isMobile? "5vw": "1.5vw", marginRight: "0vw", borderRadius: "1vw"}} href="tel:9981069233">Contact</a>
         <a style = {{padding: "1vw 4vw", backgroundColor: "#25D366", color: "#fff", textDecoration: "none", 
          fontFamily: "sans-serif", fontSize: isMobile? "5vw": "1.5vw", marginLeft: "0", borderRadius: '1vw'}} href="https://api.whatsapp.com/send?phone=9981069233">
          WhatsApp
         </a>
       </div> 
      </Container>
