...
const SearchResult = () => {
  ...
  return (
    <div style = {{backgroundColor: "#F1F2F2"}}>
      <div style = {{backgroundColor: "#F2FCFF", width: "100%", height: "auto", padding: "1vw 1vw"}}>
      ...
      <div style = {{marginLeft: "11vw", fontSize: "2vw", marginTop: "2vw", padding: "0"}}>Showing 2 of 5</div>
      <div style = {{marginLeft: "11vw", fontSize: "3vw", marginTop: "0", padding: "0", borderStyle: "solid", 
        marginRight: "0.5vw", marginBottom: "1vw", width: "80%"}}>Projects In {searchParams.get("location")}</div>
      ...
      <ul style = {{width: "80%", margin: "auto", position: "relative", height: "auto", padding: "0", display: "block"}}>
       {properties.map((property) => (
        <div style = {{borderStyle: "hidden", borderRadius: "2vw", width: "100%", height: "auto", backgroundColor: "#FAFEFF", 
         ...
         <img style = {{width: "50%"}} src={`http://localhost:8080/${property.images[0]}`}
                    alt={`Property`}/>
